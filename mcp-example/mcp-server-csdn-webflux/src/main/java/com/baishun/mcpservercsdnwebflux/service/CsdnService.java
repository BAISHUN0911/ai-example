...
import com.baishun.mcpservercsdnwebflux.model.ArticleFunctionRequest;
import com.baishun.mcpservercsdnwebflux.model.ArticleFunctionResponse;
import com.baishun.mcpservercsdnwebflux.model.CsdnPostRequest;
...
public class CsdnService {
  ...
  public ArticleFunctionResponse postToCsdn(@RequestBody ArticleFunctionRequest request) {
    ...
    headers.set("x-ca-key", xCaKey);
    headers.set("x-ca-nonce", xCaNonce);
    headers.set("x-ca-signature", xCaSignature);
    ...
    return new ArticleFunctionResponse("success post article");
  }
